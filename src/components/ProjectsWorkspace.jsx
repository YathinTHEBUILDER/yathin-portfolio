...
import { Folder, X, Minus, Maximize2, ArrowLeft } from 'lucide-react';
...
export default function ProjectsWorkspace() {
  ...
  if (!isDesktop) {
    ...
    return (
      <div className="w-full min-h-screen bg-bg flex flex-col py-12 px-[6vw] z-10 relative">
        <div className="flex items-center gap-3 mb-8">
          <a href="/" className="flex items-center gap-2 font-mono-custom text-xs text-text3 hover:text-accent transition-colors uppercase tracking-widest">
            <ArrowLeft size={14} /> Back
          </a>
        </div>
        <div className="projects-header flex flex-col space-y-2 mb-10">
          <h2 className="text-2xl sm:text-4xl font-display font-extrabold uppercase tracking-tight text-text1">
            SELECTED WORK
          </h2>
    ...
    <div className="relative w-full h-[100svh] min-h-[700px] overflow-hidden bg-bg selection:bg-accent/30 flex flex-col font-display z-10 border-t border-white/5">
      ...
      <div className="h-7 w-full bg-black/40 backdrop-blur-md border-b border-white/5 flex items-center px-4 justify-between z-50 text-[0.65rem] tracking-wider uppercase text-text3 font-mono-custom">
        <div className="flex items-center gap-5">
          <a href="/" className="font-bold text-text1 hover:text-accent transition-colors flex items-center gap-2 cursor-pointer">
            <ArrowLeft size={12} />
            Portfolio
          </a>
